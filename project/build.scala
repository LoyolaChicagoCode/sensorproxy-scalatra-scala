...
object MyScalatraWebAppBuild extends Build {
  val Organization = "edu.luc.etl"
  val Name = "Loyola ETL Scalatra Hello App"
  val Version = "0.1.0-SNAPSHOT"
  val ScalaVersion = "2.10.1"
  val ScalatraVersion = "2.2.0"

  lazy val project = Project (
    "hello-scalatra-scala",
    file("."),
    settings = Defaults.defaultSettings ++ ScalatraPlugin.scalatraWithJRebel ++ scalateSettings ++
    com.typesafe.sbt.SbtStartScript.startScriptForClassesSettings ++ Seq(
